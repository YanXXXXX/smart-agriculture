...
export const constantRoutes = [
  ...
  {
    path: '/preview',
    component: (resolve) => require(['@/views/trace/components/EditPage/Preview/index'], resolve),
    hidden: true,
  },
  {
  ...
  {
    path: '/logining',
    component: (resolve) => require(['@/views/logining'], resolve),
    hidden: true
  },
  {
    path: '/register',
  ...
  // {
  //   path: '/chat',
  //   component: (resolve) => require(['@/views/aiagent/index'], resolve),
  // },
  //XXX:修改首页的路由
//   {
//     path: '',
