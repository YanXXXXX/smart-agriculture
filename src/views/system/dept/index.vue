<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="deptId" label="部门ID" align="center" width="100"></el-table-column>
      <el-table-column prop="status" label="部门类型" align="center" width="200">
    ...
    <el-dialog
        title="完善基地信息"
        :visible.sync="baseOpen"
        v-if="baseOpen"
        width="60%">
        <base-info ref="baseinfo" :deptId="deptId" @validate="validate"></base-info>
        <span slot="footer">
        <el-button @click=" baseOpen= false">取消</el-button>
        <el-button type="primary" @click="submitBaseinfo">确定</el-button>
    </span>
    </el-dialog>
...
export default {
  ...
  components: { Treeselect,BaseInfo },
  data() {
    return {
      // 遮罩层
      loading: true,
