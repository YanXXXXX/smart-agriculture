 ...
 * @param {*} seriesName 系列名称（展示在悬浮上的标题）
 * @param {*} legendData ['苹果', '香蕉', '橙子', '梨子', '西瓜']
 * @param {*} seriesData [
                            { value: 335, name: '苹果' },
                            { value: 310, name: '香蕉' },
                            { value: 234, name: '橙子' },
 ...
 */
let normalPieChart = function(dom,title,seriesName,legendData,seriesData){
    let myChart = vm.$echarts.init(dom);
    ...
    var option = {
        ...
        legend: {
            orient: 'vertical',
            left: 'left',
            data: legendData|| ['苹果', '香蕉', '橙子', '梨子', '西瓜']
        },
        series: [
            {
                name: seriesName||'销售量',
 ...
 */
let mapChart = function(dom,data,i,bgColor,lineColor,title){
    let myChart = vm.$echarts.init(dom);
...
export { pieChart,normalPieChart,lineChart,mapChart }
