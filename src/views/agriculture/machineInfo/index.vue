  ...
  <div class="app-container-sm">
    <el-card class="card-margin-bottom">
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px"
        ...
        <el-form-item class="fr">
          <el-button v-if="!isAdmin" type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
      ...
      <el-table v-loading="loading" :data="machineInfoList">
        ...
        <el-table-column label="农机类别" align="center" prop="machineTypeId">
            <template slot-scope="scope">
                ...
                :value="scope.row.machineTypeId"
                labelName="machineTypeName"
                valueName="machineTypeId"
                type=""
                />
            </template>
        </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="农机类别" prop="machineTypeId" >
          <el-select  class="display-block" v-model="form.machineTypeId" placeholder="请选择农机类别">
            <el-option v-for="item in machineTypeList" :key="item.machineTypeId" :label="item.machineTypeName"
              :value="item.machineTypeId"></el-option>
          </el-select>
        </el-form-item>
