<template>
  <div class="app-container-sm">
    <el-card class="card-margin-bottom">
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="60px" class="form-minus-bottom">
        <base-select v-model="queryParams.baseId"></base-select>
        <el-form-item label="标题" prop="title">
          <el-input v-model="queryParams.title" placeholder="请输入标题" class="width-100" clearable size="small" @keyup.enter.native="handleQuery" />
        </el-form-item>
        <el-form-item label="分类" prop="categoryName" >
          <el-select v-model="queryParams.categoryName" size="small" class="width-100">
        ...
        <el-form-item label="置顶" prop="isTop">
          <el-select v-model="queryParams.isTop" placeholder="是否置顶" clearable size="small" class="width-100">
        ...
        <el-form-item label="轮播" prop="isBanner">
          <el-select v-model="queryParams.isBanner" placeholder="是否轮播" clearable size="small" class="width-100">
            <el-option v-for="dict in dict.type.iot_yes_no" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>

        <el-form-item label="发布" prop="status">
          <el-select v-model="queryParams.status" placeholder="选择状态" clearable size="small" class="width-100">
            <el-option v-for="dict in dict.type.iot_yes_no" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item class="fr">
          <el-button type="primary" v-if="!isAdmin" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['iot:news:add']">新增</el-button>
    ...
    <el-card class="card-padding-bottom">
      <el-table v-loading="loading" :data="newsList" @selection-change="handleSelectionChange">
        <el-table-column label="图片" align="center" prop="imgUrl" width="170px;">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button size="small" class="padding-5" type="primary" icon="el-icon-view" @click="openDetailDialog(scope.row.newsId)">查看</el-button>
            <el-button size="small" class="padding-5" type="warning" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['iot:news:edit']">修改</el-button>
            <el-button size="small" class="padding-5" type="danger" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['iot:news:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { listNewsCategory } from '@/api/iot/newsCategory';
...
export default {
  ...
  methods: {
    async init() {
      ...
      const { rows } = await listNewsCategory();
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除新闻资讯编号为"' + newsIds + '"的数据项？')
        .then(function () {
