...
<div style="padding-left:20px;">
    ...
    <el-table v-loading="loading" :data="modelList" size="mini">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
                <el-button  size="mini" type="primary" class="padding-5" icon="el-icon-edit"  @click="handleUpdate(scope.row)" v-if="productInfo.status!=2">修改</el-button>
                <el-button size="mini" type="danger"  class="padding-5" icon="el-icon-delete" @click="handleDelete(scope.row)" v-if="productInfo.status!=2">删除</el-button>
            </template>
        </el-table-column>
    </el-table>

    <!-- 添加或修改物模型对话框 -->
    <el-dialog v-if="open" :title="title" :visible.sync="open" width="700px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="模型名称" prop="modelName">
                <el-input v-model="form.modelName" placeholder="请输入物模型名称，例如：温度" class="w100" />
            </el-form-item>
            ...
            <el-form-item label="模型排序" prop="modelOrder">
                <el-input v-model="form.modelOrder" placeholder="请输入排序" type="number" class="w100" />
            </el-form-item>
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <el-form-item  prop="isReadonly">
                        ...
                        <el-switch v-model="form.isReadonly" active-text="" inactive-text="" :active-value="1" :inactive-value="0" :disabled="form.type==3 || form.dataType=='object'">
                        </el-switch>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
            ...
            <div v-if="form.datatype == 'integer' || form.datatype == 'decimal'">
                ...
                <el-form-item label="步长" prop="specs.step">
                    ...
                    <el-input v-model="form.specs.step" placeholder="请输入步长，例如：1" type="number" class="w100" />
                </el-form-item>
            </div>
    ...
    methods: {
        ...
        handleUpdate(row) {
            ...
            getModel(modelId).then((response) => {
                ...
                console.log('tempForm',JSON.parse(JSON.stringify(tempForm)))
                this.form = tempForm;
