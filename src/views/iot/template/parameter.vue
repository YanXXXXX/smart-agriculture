...
<div style="padding:6px;">
    <!-- 添加或修改通用物模型对话框 -->
    <el-dialog title="编辑参数" :visible.sync="openEdit" width="1000px" append-to-body>
        <div style="margin:-30px 0 30px;background-color:#ddd;height:1px;"></div>
        <el-row>
            <el-col :span="8" style="border:1px solid #ddd; border-radius:5px;padding:10px;background-color:#eee;">
            ...
            <el-col :span="15" :offset="1">
                <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                    <el-form-item label="参数名称" prop="name">
                        <el-input v-model="form.name" placeholder="例如：温度" class="w100" size="small" />
                    </el-form-item>
                    <el-form-item label="参数标识" prop="id">
                        <el-input v-model="form.id" placeholder="例如：temperature" class="w100" size="small">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="参数排序" prop="order">
                        <el-input-number controls-position="right" v-model="form.order" placeholder="请输入排序" type="number" class="w100" size="small" />
                    </el-form-item>
                    ...
                    <el-form-item label="数据类型" prop="datatype">
                        <el-select v-model="form.datatype" placeholder="请选择数据类型" class="w100" size="small">
                    ...
                    <div v-if="form.datatype == 'integer' || form.datatype == 'decimal'">
                        ...
                        <el-form-item label="单位">
                            <el-input v-model="form.specs.unit" placeholder="例如：℃" class="w100" size="small" />
                        </el-form-item>
                        <el-form-item label="步长">
                            <el-input-number controls-position="right" v-model="form.specs.step" placeholder="例如：1" type="number" class="w100" size="small" />
                        </el-form-item>
                    </div>
    ...
    watch: {
        data: function (newVal, oldVal) {
            ...
            if (newVal && newVal.parameter.name && newVal.parameter.name != "") {
                ...
                this.form.isRecord = newVal.parameter.isRecord;
                this.form.modelIcon = newVal.parameter.modelIcon;
    ...
    methods: {
        ...
        rowClick(item) {
            if (item != null && item.datatype != 'array' && item.datatype != 'object') {
                ...
                this.form.isRecord = item.isRecord;
                this.form.modelIcon = item.modelIcon;
