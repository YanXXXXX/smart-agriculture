<template>
  <div class="map_demo" ref="myMap">
    <el-input readonly @click.native="init()" :value="value" :disabled="disabled" style="width:100%" prefix-icon="el-icon-location-information" placeholder="请选择坐标"></el-input>
    <el-dialog title="位置选择" v-show="visible" :visible="true" width="800px" :close-on-click-modal="false" :modal="false" @close="visible=false;pointShow=false">
      <div class="boxCon">
        ...
        <div class="operate">
          <el-popover placement="right-start" width="400" trigger="click" title="地址搜索" v-model="isShow">
            <div class="search" v-if="type">
              <i class="el-icon-sort" @click="changeType"></i>
              <el-autocomplete style="width: 100%" v-model="address" :fetch-suggestions="fetchLocationData" placeholder="请输入查询关键字" @select="handleSelect" class="margin-tb-6">
