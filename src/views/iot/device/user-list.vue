<template>
<el-dialog title="选择用户" :visible.sync="openSelectUser" append-to-body width="800px">
    ...
    <el-form :model="queryParams" ref="queryForm"  :inline="true" label-width="80px">
        <el-form-item label="用户姓名" prop="nickName">
            <el-input type="text" placeholder="请输入用户用户姓名" v-model="queryParams.nickName" minlength="10" clearable size="small" show-word-limit style="width: 240px" @keyup.enter.native="handleQuery"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="addDeviceUser" v-if="type=='share'">分享</el-button>
        <el-button type="primary" @click="editDeviceOwner" v-if="type=='edit'">确定</el-button>
